...
cmd1 = """CREATE TABLE IF NOT EXISTS USERS (id INTEGER PRIMARY KEY AUTOINCREMENT, username, email, password varchar(50) NOT NULL, settings_previous_scan_period INTEGER DEFAULT 3, API_KEY TEXT)"""
