...
cmd1 = """CREATE TABLE IF NOT EXISTS USERS (id INTEGER PRIMARY KEY AUTOINCREMENT, username, email, password varchar(50) NOT NULL, settings_previous_scan_period INTEGER DEFAULT 3, API_KEY TEXT, API_USAGE INTEGER DEFAULT 0, API_USE_RESET TIMESTAMP)"""
...
cmd2 = """CREATE TABLE IF NOT EXISTS history (id INTEGER PRIMARY KEY AUTOINCREMENT, URL, TIMEDATE, TOTALSCORE, CLASSIFICATION,
           html_text_score INTEGER, html_text_keywords TEXT, html_tag_score	INTEGER, html_detected_tags	TEXT, domain_closest TEXT,
            ...
            ip_address TEXT, ip_country TEXT, ip_city TEXT, color TEXT, In_database BOOLEAN DEFAULT FALSE)"""
...
cmd4 = """CREATE TABLE IF NOT EXISTS statistics (id INTEGER PRIMARY KEY AUTOINCREMENT, date TEXT UNIQUE, Safe INTEGER DEFAULT 0, Low_Risk INTEGER DEFAULT 0, Suspicious INTEGER DEFAULT 0, Likely_Phishing INTEGER DEFAULT 0, Phishing INTEGER DEFAULT 0)"""
